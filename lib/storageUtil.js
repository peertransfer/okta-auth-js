...
function testStorage(storage) {
  // Ensure that we can read/write to storage.
  // This prevents "read-only" storage errors when end-users explicitly
  // opt to not store data in private browsing modes.
  try {
    var testKey = 'okta-token-storage-verification';
